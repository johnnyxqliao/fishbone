		...
		function initTemplatesAndHrefs() {
			$
					.ajax({
						...
						type : "GET",
						url : origin
								+ "/InnovationToolsPlatform/API/titleBarHrefs",
						data : {
							"username" : "${username}"
						},// 你的formid
						async : false,
							...
							case 0:
								...
								if (data.templates.length > 0) {
									...
									for (var i = 0; i < data.templates.length; i++) {
										templates
												.append("<li> <a data-toggle=\"dropdown\" href=\""
														+ data.templates[i].href
														+ "\" onclick=\"gotoHref(this)\" class=\"dropdown-toggle\"> <img class=\"nav-user-photo\" src=\"" + data.templates[i].src + "\"/>"
								...
								for (var i = 0; i < data.hrefs.length
										&& i < data.hrefs_num; i++) {
